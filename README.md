...
- 🔽 **Фильтр по уровню критичности** — выбор уровней для отображения (высокий/средний/норма)
  - Фильтры работают одновременно: можно искать пользователя и показывать только определённые уровни
...
**Экспорт отчёта:**
- 📄 **PDF-отчёт** — формирует документ со статистикой и таблицей аномалий (первые 20 записей)
